              ...
              <Box w="80%" m="20px auto">
                <HStack gap="20px">
                  <Box w="60%">
                    ...
                    <Select placeholder="India" id="country" value={data.country} onChange={(e)=>handleData(e)} textTransform={"uppercase"}>
                  ...
                  <Box>
                    ...
                    <Select placeholder="inr" id="currency" onChange={(e)=>handleData(e)} textTransform={"uppercase"} value={data.currency}>
